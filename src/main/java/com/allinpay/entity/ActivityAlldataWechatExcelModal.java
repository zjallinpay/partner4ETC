...
@Data
@NoArgsConstructor
public class ActivityAlldataWechatExcelModal extends BaseRowModel implements Serializable {
     ...
     * 商户名称
     */
    @ExcelProperty(value="消耗商户号",index=10)
     ...
     * 商户名称
     */
    @ExcelProperty(value="设备号",index=11)
